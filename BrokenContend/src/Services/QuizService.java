...
/**
 * QuizService enables the client to play a quiz game. It uses functions
 * implemented in classes QuizHandler and UserHandler.
 * 
 * 
 * @author Nico
 *
...
public class QuizService extends Service {
	...
	public byte[] getAnswer(String payload) {
		...
		case "1": // end game
			...
			// else {
			//
			// msg = userHandler.setGameEntry(highscore, payloadArray[1],
			// gameId);
			// }
			break;
		case "2": // request highscore
			msg = userHandler.getHighscore(gameId).playerName;
			break;
